...
<head>
    ...
    <link rel="stylesheet" href="../assets/css/indexPrin.css">
    ...
    <nav class="navbar">
        ...
        <div class="navbar-right">
            ...
            <?php else: ?>
                ...
                <!-- Mostrar el botón de "Mis Reservas" si el usuario no tiene local -->
                <a href="my_reservations.php" class="reservations-btn">Mis Reservas</a>
            <?php endif; ?>
